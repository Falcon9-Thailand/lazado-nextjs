      ...
      <div className="max-w-md w-full space-y-8">
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            ...
            <a
              href="#"
              className="font-medium text-yellow-400 hover:text-yellow-200"
            >
              เกี่ยวกับเรา
            </a>
          </p>
        ...
        <form className="mt-12 space-y-6" action="#" method="POST">
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow"
            >
              เข้าสู่ระบบ
            </button>
          </div>
